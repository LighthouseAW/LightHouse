...
# i2mp3.file.attach(io: File.open('./audio/ritual.mp3'), filename: 'Again.mp3', content_type: 'audio/mp3')
# i3mp3.file.attach(io: File.open('./audio/khxncollab.mp3'), filename: 'khxncollab.mp3', content_type: 'audio/mp3')
