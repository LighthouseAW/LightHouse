...
i1mp3.file.attach(io: File.open('/Users/ianholsteen/development/code/phase-5/jonnyniceproject/public/audio/Vile x train x flemps.mp3'), filename: 'Vile x train x flemps.mp3', content_type: 'audio/mp3')
i2mp3.file.attach(io: File.open('/Users/ianholsteen/development/code/phase-5/jonnyniceproject/public/audio/ritual.mp3'), filename: 'Again.mp3', content_type: 'audio/mp3')
i3mp3.file.attach(io: File.open('/Users/ianholsteen/development/code/phase-5/jonnyniceproject/public/audio/khxncollab.mp3'), filename: 'khxncollab.mp3', content_type: 'audio/mp3')
