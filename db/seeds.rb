...
pBelightFm = Project.create(name: 'Belight FM',
    ...
    blurb: "We hope that this station will be a cause of blessing and encouragement for all who listen to it!", 
    mission_statement: "Belight FM is the only evangelical FM station in all of Lebanon, broadcasting hope, reconciliation and transformation through the message of Jesus Christ. We have a variety of content from live talk shows to teaching to worship music written and produced in the Arab World.", 
    about: "In light of the circumstances that Lebanone and the region are going through and the ongoing difficult news, we want to proclaim that in the midst of this darkness “let there be light!” from the source of light, peace and true joy!",
