...
export default function Navbar() {
    ...
    return (
        <div  className={`fixed ${ isMobile ? '' : 'w-full'} z-40 h-20 flex bg-slate-100 text-black items-center`} >
            <div className={`${isMobile ? 'px-16' : "flex-grow mx-16" } flex justify-between z-11 text-3xl`}>
                    <Link href="/" onClick={() => {
