...
export default function Navbar() {
    ...
    return (
        <div  className='fixed w-full z-40 h-20 flex bg-slate-100 text-black items-center' >
            ...
            { isMobile ? <><button onClick={handleClick}
            ...
            : <div className="static right-0 mx-28">
                ...
                <div className="dropdown-container hover:bg-orange-200">
                    <Link
                        ...
                        className={`text-white h-20 w-60 bg-[#f18802] flex justify-center items-center text-2xl ${selectedSubLink === "give" ? "underline" : ""}`}
                        >
                        Give
                        </Link>
                </div>
