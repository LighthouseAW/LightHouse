                ...
                <div className="flex-grow w-5/6 pt-40 pb-20 text-white z-20 relative">
                    ...
                    <div className="flex justify-between items-center">
                        ...
                        {isMobile ? <></> : <div className="relative">
                            <Image alt="picture" src="/images/CoreValues.jpeg" className="relative z-20" width="400" height="400"/>
                            <svg className="z-10 absolute top-0 right-0 mt-4 mr-40  hidden lg:block" width="289.3" height="275" fill="none" viewBox="0 0 404 384" aria-hidden="true">
                                <defs>
