...
import ATopPhoto from '../../public/wamstuff/ATopPhoto.png';
                    ...
                    <div className="flex items-center justify-center z-20">
                        ...
                        {isMobile ? <></>:<div className="w-1/2 relative z-20 flex items-center justify-center pt-20 pb-20">
                               ...
                               <div className="relative space-y-24 flex flex-col justify-center items-center mt-6">
                                   <Image alt="picture" src={ATopPhoto} width="800" height="400" className="relative z-20 rounded-3xl" />
                           ...
                           <div className={`${isMobile ? "" : "w-1/2 "}  relative z-20  mb-12 pl-8`}>
